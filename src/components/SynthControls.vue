<template>
  <div class="synth-box">
    ...
    <div class="controls">
      ...
      <label class="ctl">Vol <input type="range" min="0" max="1" step="0.01" v-model.number="track.synth.master" @input="applySynth" /></label>
      <label class="ctl">Cutoff <input type="range" min="100" max="12000" step="10" v-model.number="track.synth.cutoff" @input="applySynth" /></label>
...
.header { font-weight: 600; font-size: 12px; color: var(--muted); }
